% This demo shows the capability of recoverying COMPLEX valued signals
...
clf;
subplot(121)
plot(real(Wgen),'b-','linewidth',2); hold on
plot(imag(Wgen),'r--','linewidth',2); grid on; axis tight
hx1 = xlabel('(a) Original Complex Signal'); hy1 = ylabel('Amplitude');
ax1 = gca;
subplot(122)
plot(real(Result2.x),'b-','linewidth',2); hold on
plot(imag(Result2.x),'r--','linewidth',2); grid on; axis tight
...
set([ax1 ax2],'FontName','Times','FontSize',13);
